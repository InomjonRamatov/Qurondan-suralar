...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private List<Surah> _listDataHeader; // header titles
    // child data in format of header title, child title
    private HashMap<String, List<String>> _listDataChild;

    public ExpandableListAdapter(Context context, List<Surah> listDataHeader,
    ...
    public Object getChild(int groupPosition, int childPosititon) {
        //todo bunday ishlatish notugri, negaligini sherzoddan sura
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        String headerTitle = ((Surah) getGroup(groupPosition)).title;
        if (convertView == null) {
            LayoutInflater infalInflater = (LayoutInflater) this._context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
